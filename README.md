...
<p align="center">
  <b>Senior Cloud Security Engineer</b> · Berlin, Germany 🇩🇪 &nbsp;|&nbsp; 9+ years securing cloud, containers & code
</p>
...
I'm a cloud security engineer who builds and scales security programs across **multi-cloud + Kubernetes-native** environments. Currently at **[commercetools](https://commercetools.com)** in Berlin, where I work on GCP audit logging, runtime threat detection, incident response, application security review, and policy-as-code with Terraform.
...
`Cloud & Containers` &nbsp;![GCP](https://img.shields.io/badge/GCP-4285F4?style=flat&logo=googlecloud&logoColor=white)&nbsp;![AWS](https://img.shields.io/badge/AWS-232F3E?style=flat&logo=amazonaws&logoColor=white)&nbsp;![Azure](https://img.shields.io/badge/Azure-0078D4?style=flat&logo=microsoftazure&logoColor=white)&nbsp;![Kubernetes](https://img.shields.io/badge/K8s-326CE5?style=flat&logo=kubernetes&logoColor=white)&nbsp;![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white)

`Security & Detection` &nbsp;![Orca](https://img.shields.io/badge/Orca-6C47FF?style=flat&logoColor=white)&nbsp;![Wazuh](https://img.shields.io/badge/Wazuh-3467F6?style=flat&logo=wazuh&logoColor=white)&nbsp;![SonarQube](https://img.shields.io/badge/SonarQube-4E9BCD?style=flat&logo=sonarqube&logoColor=white)&nbsp;![Burp](https://img.shields.io/badge/Burp-FF6633?style=flat&logo=burpsuite&logoColor=white)&nbsp;![OWASP](https://img.shields.io/badge/OWASP-000000?style=flat&logo=owasp&logoColor=white)

`IaC & Languages` &nbsp;![Terraform](https://img.shields.io/badge/Terraform-7B42BC?style=flat&logo=terraform&logoColor=white)&nbsp;![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)&nbsp;![Bash](https://img.shields.io/badge/Bash-4EAA25?style=flat&logo=gnubash&logoColor=white)&nbsp;![Actions](https://img.shields.io/badge/Actions-2088FF?style=flat&logo=githubactions&logoColor=white)&nbsp;![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat&logo=linux&logoColor=black)
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4>☁️ Cloud Security</h4>
      <ul>
        <li><a href="https://github.com/mandeeps13k/gcp-scc-finding-notification-jira-cloud">gcp-scc-finding-notification-jira-cloud</a> — SCC findings → Jira</li>
        <li><a href="https://github.com/mandeeps13k/wazuh-terraform-modules">wazuh-terraform-modules</a> — AWS/GCP Wazuh SIEM modules</li>
        <li><a href="https://github.com/mandeeps13k/wazuh-custom-rules">wazuh-custom-rules</a> — GCP event detection rules</li>
        <li><a href="https://github.com/mandeeps13k/gcp-cloud-audit">gcp-cloud-audit</a> — GCP audit tooling</li>
        <li><a href="https://github.com/mandeeps13k/scc-tf-secure-templates">scc-tf-secure-templates</a> — tfsec in PR comments</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h4>🔐 AppSec, K8s & Tooling</h4>
      <ul>
        <li><a href="https://github.com/mandeeps13k/sonar-jira-integration">sonar-jira-integration</a> — SonarQube issues → Jira</li>
        <li><a href="https://github.com/mandeeps13k/appsec-checklist">appsec-checklist</a> — Web & API security checklist</li>
        <li><a href="https://github.com/mandeeps13k/claude-skills">claude-skills</a> — security automation skills</li>
        <li><a href="https://github.com/mandeeps13k/cks-notes">cks-notes</a> — CKS exam notes</li>
        <li><a href="https://github.com/mandeeps13k/cka-notes">cka-notes</a> — CKA exam notes</li>
      </ul>
    </td>
  </tr>
</table>
...
<p align="center"><i>Secure by design, not by accident.</i></p>
